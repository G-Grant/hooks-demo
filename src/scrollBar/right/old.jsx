...
export default class RightContainer extends PureComponent{
    ...
    componentDidUpdate(){
        ...
        if(scrollTop !== this.rightContainer.scrollTop){
            this.rightContainer.scrollTop = scrollTop;
        }
    }

    render(){
        return(
            <div onScroll={this.onScroll} ref={node=>this.rightContainer=node}>
